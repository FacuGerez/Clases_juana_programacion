...
public class Parcial1 {
	...
	public static void main(String[] args) {
		...
		System.out.printf(
				"El precio de la primer pizza '4 Quesos' es ?: %f \n" ,laPizzeria.precioVentaDeLaPrimerPizza("4 Quesos"));
		System.out.printf(
				"Cantidad de Pizzas vendidas entre $1000 y $2000?: %d\n",laPizzeria.vendidasConPrecioEntre(1000, 2000));
		System.out.printf("La sumatoria de ventas de todas las pizzas 'Canchera' es ?: %f\n"
